from sklearn4.neural_network import MLPClassifier
...
y_training_data_final = np.append(y_training_data,y_valid_data).reshape(-1,1)
print(y_training_data_final)
print(len(y_training_data_final))
...
mlp = MLPClassifier(solver='sgd', activation='relu',alpha=1e-4,hidden_layer_sizes=(64,64), random_state=1,max_iter=10,verbose=10,learning_rate_init=.1)
# 使用solver='sgd'，准确率为98%，且每次训练都会分batch，消耗更小的内存

# 训练模型
mlp.fit(x_training_data_final[450000:60000], y_training_data_final[45000:60000])
