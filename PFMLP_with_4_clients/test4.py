...
from skl4clientd.metrics import accuracy_score, confusion_matrix, classification_report
from skl4clientd.model_selection import train_test_split, cross_val_score
from skl4clientd.neural_network import MLPClassifier, MLPRegressor
from skl4clientd.preprocessing import StandardScaler
import socket
import time
...
X = data_array[300:400,0:-1]
y = data_array[300:400,-1]
...
cls = MLPClassifier(activation='relu', alpha=1e-05, batch_size=100, beta_1=0.9,
