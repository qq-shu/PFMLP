...
from skl4clientc.metrics import accuracy_score, confusion_matrix, classification_report
from skl4clientc.model_selection import train_test_split, cross_val_score
from skl4clientc.neural_network import MLPClassifier, MLPRegressor
from skl4clientc.preprocessing import StandardScaler
import socket
import time
...
X = data_array[200:300,0:-1]
y = data_array[200:300,-1]
