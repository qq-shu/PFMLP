...
from skl4clienta.metrics import accuracy_score, confusion_matrix, classification_report
from skl4clienta.model_selection import train_test_split, cross_val_score
from skl4clienta.neural_network import MLPClassifier, MLPRegressor
from skl4clienta.preprocessing import StandardScaler
import socket
import time
...
X = data_array[0:100,0:-1]
y = data_array[0:100,-1]
